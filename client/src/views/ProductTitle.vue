                            ...
                            <v-card-text>
                                <v-container>
                                    <v-row>
                                        ...
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem['Title Name']" label="Title Name"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem['Cleaned Up Title']" label="Cleaned Up Title"></v-text-field>
                                        </v-col>
                                    </v-row>
                                </v-container>
                            </v-card-text>
    ...
    export default {
        ...
        data () {
            return {
                headers: [
                    {
                        text: 'Journal title number',
                        align: 'left',
                        sortable: true,
                        value: 'Journal title number',

                    },
                    { text: 'Title Name', value: 'Title Name' },
                    { text: 'Cleaned Up Title', value: 'Cleaned Up Title' },
        ...
        async created() {
            await this.$store.dispatch('setCurrentTable', 'product_title');
