                            ...
                            <v-card-text>
                                <v-container>
                                    <v-row>
                                        ...
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem['Country_Key']" label="Country_Key"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem['Region_Key']" label="Region_Key"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem['Region']" label="Region"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem['Territory_Key']" label="Territory_Key"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field v-model="editedItem['Territory']" label="Territory"></v-text-field>
                                        </v-col>
                                    </v-row>
                                </v-container>
                            </v-card-text>
        ...
        data () {
            return {
                headers: [
                    ...
                    { text: 'Country_Key', value: 'Country_Key' },
                    { text: 'Region_Key', value: 'Region_Key' },
                    { text: 'Region', value: 'Region' },
                    { text: 'Territory_Key', value: 'Territory_Key' },
