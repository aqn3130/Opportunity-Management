<template>
    <div>
        <div fluid v-if="authUser.username === 'stephen.cohen' ||
    authUser.username === 'aqn3130'">
            <v-card
            ...
            <v-layout style="margin-top: -90px">
                <v-flex style="z-index: 2">
                    <v-card flat class="justify-center ml-auto mr-auto transparent" max-width="800">
                        <v-card-title>
                        ...
                        <v-card-text>
                            ...
                            >
                                <template v-slot:item.actions="{ item }">
                                    <v-btn :loading="isDeleting" text v-if="item.id === userIdToBeDeleted">
                                        <v-icon
                                                small
        ...
        <p v-else class="pa-5">
            You do not have access to this page, please contact your system administrator.</p>
    </div>
</template>
